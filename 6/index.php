...
$db_pass = '3345940';  // Пароль БД

// Подключаемся к базе данных на сервере.
$db = new PDO('mysql:host=localhost;dbname=u20982', $db_user, $db_pass, array(
  ...
  $errors['check'] = empty($_COOKIE['check_error']) ? '' : strip_tags($_COOKIE['check_error']);
    ...
    if (!empty($_COOKIE[session_name()]) && session_start() && !empty($_SESSION['login'])) {
        ...
        try {
            ...
            // Запрос направляется в таблицу web6 с данными пользователей
