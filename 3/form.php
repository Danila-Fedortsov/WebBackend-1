...
$lastId = null;
try {
	$stmt = $db->prepare("INSERT INTO user (name, email, gender, limbs, biography, agreement) VALUES (:name, :email, :gender, :limbs, :biography, :agreement)");
	$stmt->execute(array('name' => $name, 'email' => $email, 'gender' => $gender, 'limbs' => $limbs, 'biography' => $biography, 'agreement' => $agree));
